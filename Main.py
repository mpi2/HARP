...
class MainWindow(QtGui.QMainWindow):
    ...
    def getParamaters(self):
        ...
        # Check which slot to use for progress report
        if self.ui.radioButtonSlot1.isChecked():
               self.configOb.slot = "1"
        if self.ui.radioButtonSlot2.isChecked():
               self.configOb.slot = "2"
        if self.ui.radioButtonSlot3.isChecked():
                self.configOb.slot = "3"
        if self.ui.radioButtonSlot4.isChecked():
               self.configOb.slot = "4"
        if self.ui.radioButtonSlot4.isChecked():
               self.configOb.slot = "5"
        ...
        log.write("Slot  "+self.configOb.slot+"\n");
