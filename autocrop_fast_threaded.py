...
class Autocrop(QtCore.QThread):
    def __init__(self, in_dir, out_dir, num_proc=None, def_crop=None):
        ...
        while True:
            try:
                ...
                if self.shared_crop_count.value % 20 == 0:
                    print("file_queue:", self.crop_file_queue.qsize())
                    print("write_queue:", self.write_file_queue.qsize())
                ...
                try:
                    ...
                    self.emit( QtCore.SIGNAL('cropFinished(QString)'), "can't save cropped file {0}".format(crop_out))
